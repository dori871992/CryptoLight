...
public class DetachedSignatureProcessor
{
    ...
    /*
     * verify the signature in against the file fileName.
     */
    public static boolean verifySignature(
            String          fileName,
            InputStream     in,
    ...
    public static void createSignature(PGPSecretKey skey, InputStream in, OutputStream out, char[] pass, boolean armor)
            throws GeneralSecurityException, IOException, PGPException
    {
